...
#SBATCH --mem=24GB
#BATCH --job-name=SST-2+GATv2+BERT+Surrogate+No_Aggregation+No_Node_Noise
#SBATCH --output=SST-2+GATv2+BERT+Surrogate+No_Aggregation+No_Node_Noise_%j.out
