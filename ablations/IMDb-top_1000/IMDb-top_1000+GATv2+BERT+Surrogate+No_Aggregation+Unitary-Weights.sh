...
#SBATCH --mem=24GB
#BATCH --job-name=IMDb-top_1000+GATv2+BERT+Surrogate+No_Aggregation+Unitary_Weights
#SBATCH --output=IMDb-top_1000+GATv2+BERT+Surrogate+No_Aggregation+Unitary_Weights_%j.out
