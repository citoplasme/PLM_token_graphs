...
#SBATCH --mem=24GB
#BATCH --job-name=IMDb-top_1000+GATv2+BERT+Grouped+No_Aggregation+Random_Attentions
#SBATCH --output=IMDb-top_1000+GATv2+BERT+Grouped+No_Aggregation+Random_Attentions_%j.out
