...
#SBATCH --mem=24GB
#BATCH --job-name=Ohsumed+GATv2+RoBERTa+Grouped+No_Aggregation
#SBATCH --output=Ohsumed+GATv2+RoBERTa+Grouped+No_Aggregation_%j.out
