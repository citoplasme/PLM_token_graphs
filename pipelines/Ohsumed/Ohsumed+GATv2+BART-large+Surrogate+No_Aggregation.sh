...
#SBATCH --mem=24GB
#BATCH --job-name=Ohsumed+GATv2+BART-large+Surrogate+No_Aggregation
#SBATCH --output=Ohsumed+GATv2+BART-large+Surrogate+No_Aggregation_%j.out
