...
#SBATCH --mem=24GB
#BATCH --job-name=IMDb-top_1000+GAT+BERT+Surrogate+No_Aggregation
#SBATCH --output=IMDb-top_1000+GAT+BERT+Surrogate+No_Aggregation_%j.out
