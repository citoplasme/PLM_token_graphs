...
#SBATCH --mem=24GB
#BATCH --job-name=IMDb-top_1000+GATv2+BERT+Grouped+Global_Aggregation
#SBATCH --output=IMDb-top_1000+GATv2+BERT+Grouped+Global_Aggregation_%j.out
