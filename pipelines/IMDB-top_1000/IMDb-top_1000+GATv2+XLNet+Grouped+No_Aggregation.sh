...
#SBATCH --mem=24GB
#BATCH --job-name=IMDb-top_1000+GATv2+XLNet+Grouped+No_Aggregation
#SBATCH --output=IMDb-top_1000+GATv2+XLNet+Grouped+No_Aggregation_%j.out
